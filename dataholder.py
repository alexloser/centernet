...
from bitcv import Box, read_image, show_image
from bitcv import letterbox_embed, enter_into_letter, gray_to_color
...
class DataHolder:
    ...
    def __init__(
        self, train_list_files, input_size, num_classes, batch_size, max_boxes, channle_means=[]
    ):
    ...
    def _decode(self, line):
        ...
        for xmin, ymin, xmax, ymax, c in boxes:
            if xmax > xmin and ymax > ymin:  # not padding data
                ...
                (xmin, ymin), (xmax, ymax) = enter_into_letter(points, resized.shape[0], img.shape)
